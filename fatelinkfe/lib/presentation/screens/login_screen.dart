                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              _buildSocialButton('assets/icon/icon-tiktok.png'),
                              const SizedBox(width: 24),
                              _buildSocialButton('assets/icon/icon-zalo.png'),
                              const SizedBox(width: 24),
                              _buildSocialButton('assets/icon/icon-phone.png'),
                            ],
                          ),
                        ],
                      ),
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Container(
                              ...
                              height: 24,
                              alignment:
                                  Alignment.center, // Thêm khoảng cách với text
                              decoration: BoxDecoration(
